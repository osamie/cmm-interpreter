...
public class CMMParser {
  ...
  private void buildTable() {
    ...
    table.put("ElementPlus", new HashMap<String, GrammarRule>());
      ...
      graph[1] = new GrammarState("ElementPlus{30}", 2);
      table.get("ElementPlus").put("id", new GrammarRule("ElementPlus", false, false, graph));

    table.put("ArgumentList{32}", new HashMap<String, GrammarRule>());
      graph = new GrammarState[2];
      graph[0] = new GrammarState("listsep", 1);
      graph[1] = new GrammarState("Assignment", 2);
      table.get("ArgumentList{32}").put("listsep", new GrammarRule("ArgumentList{32}", false, true, graph));
    ...
    table.put("Comparison", new HashMap<String, GrammarRule>());
      ...
      graph[0] = new GrammarState("Sum", 2);
      graph[1] = new GrammarState("Comparison{20}", 2);
      table.get("Comparison").put("negate_l", new GrammarRule("Comparison", true, false, graph));
    ...
    table.put("ElementPlus{30}", new HashMap<String, GrammarRule>());
      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("null", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("plus", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("minus", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("ArgumentList", 2);
      table.get("ElementPlus{30}").put("lparen", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("listsep", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("or", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("mod", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("gets", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("divide", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("multiply", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("ge", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("lt", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("and", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("exp", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("rparen", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("le", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("ne", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("eol", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("gt", new GrammarRule("ElementPlus{30}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ElementPlus{30}").put("eq", new GrammarRule("ElementPlus{30}", false, true, graph));
    ...
    table.put("ArgumentList{31}", new HashMap<String, GrammarRule>());
      graph = new GrammarState[2];
      graph[0] = new GrammarState("Assignment", 2);
      graph[1] = new GrammarState("ArgumentList{33}", 2);
      table.get("ArgumentList{31}").put("id", new GrammarRule("ArgumentList{31}", false, true, graph));

      graph = new GrammarState[2];
      graph[0] = new GrammarState("Assignment", 2);
      graph[1] = new GrammarState("ArgumentList{33}", 2);
      table.get("ArgumentList{31}").put("lparen", new GrammarRule("ArgumentList{31}", false, true, graph));

      graph = new GrammarState[2];
      graph[0] = new GrammarState("Assignment", 2);
      graph[1] = new GrammarState("ArgumentList{33}", 2);
      table.get("ArgumentList{31}").put("negate_l", new GrammarRule("ArgumentList{31}", false, true, graph));

      graph = new GrammarState[2];
      graph[0] = new GrammarState("Assignment", 2);
      graph[1] = new GrammarState("ArgumentList{33}", 2);
      table.get("ArgumentList{31}").put("string", new GrammarRule("ArgumentList{31}", false, true, graph));

      graph = new GrammarState[2];
      graph[0] = new GrammarState("Assignment", 2);
      graph[1] = new GrammarState("ArgumentList{33}", 2);
      table.get("ArgumentList{31}").put("number", new GrammarRule("ArgumentList{31}", false, true, graph));

      graph = new GrammarState[2];
      graph[0] = new GrammarState("Assignment", 2);
      graph[1] = new GrammarState("ArgumentList{33}", 2);
      table.get("ArgumentList{31}").put("boolean", new GrammarRule("ArgumentList{31}", false, true, graph));
    ...
    table.put("Term", new HashMap<String, GrammarRule>());
      ...
      graph[0] = new GrammarState("Exp", 2);
      graph[1] = new GrammarState("Term{26}", 2);
      table.get("Term").put("negate_l", new GrammarRule("Term", true, false, graph));
    ...
    table.put("Element{29}", new HashMap<String, GrammarRule>());
      graph = new GrammarState[1];
      graph[0] = new GrammarState("negate_l", 1);
      table.get("Element{29}").put("negate_l", new GrammarRule("Element{29}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("Element{29}").put("string", new GrammarRule("Element{29}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("Element{29}").put("boolean", new GrammarRule("Element{29}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("Element{29}").put("number", new GrammarRule("Element{29}", false, true, graph));

    table.put("ArgumentList{34}", new HashMap<String, GrammarRule>());
      graph = new GrammarState[1];
      graph[0] = new GrammarState("ArgumentList{31}", 2);
      table.get("ArgumentList{34}").put("id", new GrammarRule("ArgumentList{34}", false, true, graph));

      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ArgumentList{34}").put("rparen", new GrammarRule("ArgumentList{34}", false, true, graph));
    ...
    table.put("Sum", new HashMap<String, GrammarRule>());
      ...
      graph[0] = new GrammarState("Term", 2);
      graph[1] = new GrammarState("Sum{23}", 2);
      table.get("Sum").put("negate_l", new GrammarRule("Sum", true, false, graph));
    ...
    table.put("Exp", new HashMap<String, GrammarRule>());
      ...
      graph[0] = new GrammarState("Element", 2);
      graph[1] = new GrammarState("Exp{28}", 2);
      table.get("Exp").put("negate_l", new GrammarRule("Exp", true, false, graph));
    ...
    table.put("Logical", new HashMap<String, GrammarRule>());
      ...
      graph[0] = new GrammarState("Comparison", 2);
      graph[1] = new GrammarState("Logical{17}", 2);
      table.get("Logical").put("negate_l", new GrammarRule("Logical", true, false, graph));
    ...
    table.put("ArgumentList{33}", new HashMap<String, GrammarRule>());
      graph = new GrammarState[1];
      graph[0] = new GrammarState("\0", 3);
      table.get("ArgumentList{33}").put("rparen", new GrammarRule("ArgumentList{33}", false, true, graph));

      graph = new GrammarState[2];
      graph[0] = new GrammarState("ArgumentList{32}", 2);
      graph[1] = new GrammarState("ArgumentList{33}", 2);
      table.get("ArgumentList{33}").put("listsep", new GrammarRule("ArgumentList{33}", false, true, graph));
    ...
    table.put("ArgumentList", new HashMap<String, GrammarRule>());
      graph = new GrammarState[3];
      graph[0] = new GrammarState("lparen", 1);
      graph[1] = new GrammarState("ArgumentList{34}", 2);
      graph[2] = new GrammarState("rparen", 1);
    ...
    table.put("Element", new HashMap<String, GrammarRule>());
      ...
      graph = new GrammarState[2];
      graph[0] = new GrammarState("Element{29}", 2);
      graph[1] = new GrammarState("Constant", 2);
      table.get("Element").put("negate_l", new GrammarRule("Element", false, false, graph));
